...
<!DOCTYPE html>
<html lang="ru">
<!-- Выполнил граф Арчибальд Хусаинов -->
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <section class="container" style="margin-top: 50px;">
        <a class="cat" href="?page=index&category=Фрукты">Фрукты</a>
        <a class="cat" href="?page=index&category=Овощи">Овощи</a>
    </section>
    ...
    <section class="container mt">
        <div class="grid">
            ...
            if ($error == 0) { ?>
                <p>По вашему запросу нет ниче</p> <a style="color: red;" href="?page=index">Вернуться к каталогу</a>
            <? }
            if ($result = $connection->query($sql)) {
                foreach ($result as $card) { ?>
                    <div class="card">
                        ...
                        <p class="price"><?= $card['price'] ?> рубликов</p>
                    </div>
                <? }
            }
